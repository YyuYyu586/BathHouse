Shader "UI/BattleBackgroundWave"
{
    Properties
    {
        ...
        _SecondaryStrength ("Secondary Strength", Float) = 0.003
        _SecondaryFrequency ("Secondary Frequency", Float) = 5
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                uv.y += sin((sourceX * _SecondaryFrequency) + (_Time.y * _WaveSpeed * 0.7)) * _SecondaryStrength;
                uv = saturate(uv);
